...
$product = $conn
  ->execute_query("SELECT products.id AS id,
            ...
            product_variant.product_img2, product_variant.product_color

            FROM products
            JOIN product_variant
            ON products.id = product_variant.product_id
            WHERE products.id = ?
            AND product_variant.product_color = ?
            ", [$id, $color])
  ->fetch_assoc();
...
$product_variant = $conn->query("SELECT 
                                 ...
                                 product_variant.product_img1 AS variant_img1,
