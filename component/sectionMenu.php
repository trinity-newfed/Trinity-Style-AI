    <section id="menu" class="head mix-blend-difference">
        ...
        <div id="text-menu">
            ...
            <div id="text" class="hidden md:flex space-x-12 text-[10px] tracking-[0.25em] pointer-events-auto uppercase font-light">
        ...
        <div id="utility-menu">
            <div class="relative">
                ...
                <span class="absolute top-[-5px] right-[-5px] bg-[transparent] text-[white] rounded-full w-[14px] h-[14px] text-[7px] flex items-center justify-center"><?=$noti?></span>
            </div>
