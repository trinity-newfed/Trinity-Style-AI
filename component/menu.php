            <?php if(isset($_SESSION['username'])): ?>
                <a onclick="window.location.href='user.php'" data-name="<?=$_SESSION['username']?>" class="menu-Username account cursor-pointer font-light hover:opacity-40 transition-opacity"></a>
            <?php else: ?>
